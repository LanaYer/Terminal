...
If(length(Edit1.Text)<10)then
   ...
   if ((Edit1.Text[1]<>'0')and(Edit1.Text[3]<>'3')and(Edit1.Text[2]<>'9')) then
      Label1.Visible:=True
      else begin
Unit2.Form2.Show;
Form1.Hide;
...
if (Edit2.Text='МТС (Украина)') then
begin
...
If(length(Edit1.Text)<10)then
   ...
   if (((Edit1.Text[1]<>'0')And(Edit1.Text[3]<>'9'))and(Edit1.Text[2]<>'5')) then
      Label1.Visible:=True
      else begin
Unit2.Form2.Show;
Form1.Hide;
...
if ((Edit2.Text<>'МТС (Украина)')and(Edit2.Text<>'Life:)')) then
begin
